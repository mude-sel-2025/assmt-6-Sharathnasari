...
def confidence_interval(N_samples=100, sample_size=40, true_mean=74, true_std=3.3, confidence=0.95):
    """
    ...
    for i in range(N_samples):
        ...
        lower = sample_mean - z * (sample_se/np.sqrt(sample_size))
        upper = sample_mean + z * (sample_se/np.sqrt(sample_size))
        # this code block ends here
